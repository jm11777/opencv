...
def interactive_edge_detection(image_path):
    ...
    while True:
        ...
        if choice=='1':
            ...
            print("Adjust thresholds for Canny(default: 10 and 200)")
            ...
            print('Adjust kernel size for Gaussiam blur(must be odd, default: 5)')
            ...
            kernel_size=int(input("Enter kernel size (odd number):"))
            blurred=cv2.GaussianBlur(image,(kernel_size,kernel_size),0)
            diplay_image("Gaussian Smoothed Image",blurred)
        elif choice=='5':
